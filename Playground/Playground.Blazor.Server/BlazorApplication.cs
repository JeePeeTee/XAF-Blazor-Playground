...
using Playground.Blazor.Server.Services;

namespace Playground.Blazor.Server {
    public partial class PlaygroundBlazorApplication : BlazorApplication {
        public PlaygroundBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void PlaygroundBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
